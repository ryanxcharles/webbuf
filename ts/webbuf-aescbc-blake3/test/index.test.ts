...
import{ aescbcBlake3Encrypt, aescbcBlake3Decrypt } from "../src/index.js";
...
describe("Index", () => {
  it("should exist", () => {
    expect(aescbcBlake3Encrypt).toBeDefined();
    expect(aescbcBlake3Decrypt).toBeDefined();
  });
});
...
describe("Encryption Tests", () => {
  it("should pass sanity check", () => {
    ...
    const encrypted = aescbcBlake3Encrypt(plaintext, key, iv);
    const decrypted = aescbcBlake3Decrypt(encrypted, key);
